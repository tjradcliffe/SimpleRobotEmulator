...
#include "GenericHID.h"
	...
	KBotDrive::KBotDrive(SpeedController *frontLeftMotor, SpeedController *rearLeftMotor,
				SpeedController *frontRightMotor, SpeedController *rearRightMotor,
				float sensitivity) : m_frontLeftMotor(frontLeftMotor), m_rearLeftMotor(rearLeftMotor), m_frontRightMotor(frontRightMotor), m_rearRightMotor(rearRightMotor) {;}
#endif
	...
	void KBotDrive::ArcadeDrive(float moveValue, float rotateValue, bool squaredInputs)
	{
		...
		m_rearRightMotor->Set(rightMotorSpeed);
		m_frontRightMotor->Set(rightMotorSpeed);
		m_rearLeftMotor->Set(leftMotorSpeed);
		m_frontLeftMotor->Set(leftMotorSpeed);
